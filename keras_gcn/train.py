...
from keras.layers import Input, Dropout, LeakyReLU
...
#H = Dropout(0.5)(X_in)
#H = GraphConvolution(4, support, activation='tanh', kernel_regularizer=l2(5e-4))([H]+G)
#H = Dropout(0.5)(H)
...
Y = Dense(y.shape[1], activation='softmax',name='g2')(H)
